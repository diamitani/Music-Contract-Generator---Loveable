...
import { UserRoundCog, Disc, MusicNote, PenTool, Mic2, FileSpreadsheet, Share2 } from 'lucide-react';
...
const ContractTypes = () => {
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      default: return <MusicNote className="w-6 h-6" />;
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 animate-slide-in-up animation-delay-200">
        {CONTRACT_TYPES.map((type, index) => (
          <button
            ...
            className="glass-panel p-6 text-left transition-all duration-300 hover:scale-105 hover:shadow-lg focus:outline-none group relative overflow-hidden"
